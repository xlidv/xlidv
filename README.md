...
- **Web Development**:  
  - Javascript, Typescript, NodeJS, React.js, Next.js, Vue.js, Nuxt.js, 
  - Express.js, NestJS,  RESTful API, MongoDB, PostgreSQL
  - Python, Django, Flask, BS
- **Cloud Platforms**:  
...
- **AI/ML**: Pytorch, Tensorflow, Scilearn, Numpy, Pandas
